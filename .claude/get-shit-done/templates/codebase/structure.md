...
- Usage: Reference from command with `@/Users/amish/Distributed_Grid/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/amish/Distributed_Grid/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/amish/Distributed_Grid/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
