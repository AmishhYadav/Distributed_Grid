...
<reference>
@/Users/amish/Distributed_Grid/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/amish/Distributed_Grid/.claude/get-shit-done/references/user-profiling.md` to load:
